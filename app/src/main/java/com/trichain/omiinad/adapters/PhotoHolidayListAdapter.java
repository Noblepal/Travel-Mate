...
public class PhotoHolidayListAdapter extends RecyclerView.Adapter<PhotoHolidayListAdapter.HolidayViewHolder> {

    List<PhotoTable> photoTables;
    Context context;
    boolean isImageFitToScreen;

    public PhotoHolidayListAdapter(List<PhotoTable> photoTables, Context context) {
